...
\chapter{Moduły}
	\section{Generator Dźwięku}
		...
		Wejścia:
			\begin{itemize} 
				\item 			\textbf{DATA} - wektor w zakresie od 0 do \{liczba\} przesylany do modułu DAC\_Write
				\item 						\textbf{T\_sync} - sygnał synchronizujący generowanie sygnału przez moduł DAC\_Write
			\end{itemize}
